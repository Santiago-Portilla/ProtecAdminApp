...
class CreateReflective @Inject constructor(private val repository: ReflectiveRepository) {

    suspend operator fun invoke(reflective: Reflective) = repository.createReflective(reflective)
