package com.portosdeveloper.protecadminapp.presentation.screens.SearchWithQR
...
import com.portosdeveloper.protecadminapp.presentation.screens.SearchWithQR.components.SearchWithQRState
...
@HiltViewModel
class SearchWithQRViewModel @Inject constructor(
    private val packageUseCases: PackageUseCases
) : ViewModel() {

    var state by mutableStateOf(SearchWithQRState())
